...
```bash
# Clone with HTTPS
fgit clone https://github.com/charles-alchemcy/glasses-ai.git

# Or clone with SSH
git clone git@github.com:charles-alchemcy/glasses-ai.git
...
git clone https://github.com/charles-alchemcy/glasses-ai.git
cd glasses-ai
